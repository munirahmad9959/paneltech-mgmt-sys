            ...
            <div className='flex justify-between items-center h-[70px] max-w-full mr-2 md:mr-10 md:ml-3'>
                <div className="flex items-center space-x-1 w-1/2 md:relative ml-2">
                    <a href="/" className='bg-white rounded-full '>
                        <img src="./resources/logo-remote.png" alt="logo" className="w-[170px] md:w-[110px] cursor-pointer z-10" />
                    </a>
                ...
                <nav className="flex items-center space-x-1 md:relative">
                    ...
                    <button className='text-[#5a05ff] bg-[#fff] px-3 py-1 rounded-full transition duration-200 hover:bg-[#efe5ff] cursor-pointer' onClick={handleClick}>Log in</button>
                    <button
                    ...
                    <button className='text-[#5a05ff] bg-[#fff] px-4 py-2 rounded-full transition duration-200 hover:bg-[#efe5ff] hidden md:flex items-center cursor-pointer'>Book a Demo</button>
                </nav>
            </div>
        </div>
    );
